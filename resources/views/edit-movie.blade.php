                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="POST" action="/movies/movie/{{$movie->slug}}/edit" class="flex justify-center flex-col items-center" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input placeholder="{{__('placeholders.movie_name')}}"  value="{{old('name', $movie->title)}}" type="text" id="title" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('title')
