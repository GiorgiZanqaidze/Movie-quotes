<x-panel>
        ...
        <form method="POST" action="/movies/movie/create" class="flex justify-center flex-col items-center" enctype="multipart/form-data">
            @csrf
                <div class="flex">
                    <div class="mb-6">
                            <label for="title_en" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('forms.movie_title')}} ({{__('forms.en')}})</label>
                    ...
                    <div class="mb-6">
                            <label for="title_ka" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('forms.movie_title')}} ({{__('forms.ka')}})</label>
                    ...
                    <div class="flex justify-center mb-4">
                        <button type="submit" class="text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{__('forms.add')}}</button>
                    </div>
                </div>
        </form>
 </x-panel>
